...
public class SharedPrefereneUtils {
    ...
    public static <E>boolean putList(Context mContext, String key, List<E> objectList){
        return SharedPrefereneUtils.putString(mContext, key, new Gson().toJson(objectList));
    }
    ...
    public static <E>List<E> getList(Context mContext, String key){
        ...
        String json = SharedPrefereneUtils.getString(mContext, key, null);
